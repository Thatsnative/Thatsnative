...
import static com.example.epic.db.entity.SourceType.FILE;
import static com.example.epic.db.entity.SourceType.UNSUPPORTED;
import static com.example.epic.db.entity.SourceType.URL;
...
public class HostsSource {
    ...
    private String sourceBlockType;
    ...
    public String getSourceBlockType() {
        return this.sourceBlockType;
    }

    public void setSourceBlockType(@NonNull String SourceBlockType) {
    ...
    public SourceType getType() {
        if (this.url.startsWith("https://")) {
            return URL;
        } else if (this.url.startsWith("content://") || this.url.startsWith("assets://")) {
            return FILE;
        } else {
            return UNSUPPORTED;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + sourceBlockType.hashCode();
