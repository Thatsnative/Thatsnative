...
package com.example.epic.vpn.dns.DNS.spi;

import com.example.epic.vpn.dns.DNS.AAAARecord;
import com.example.epic.vpn.dns.DNS.ARecord;
import com.example.epic.vpn.dns.DNS.ExtendedResolver;
import com.example.epic.vpn.dns.DNS.Lookup;
import com.example.epic.vpn.dns.DNS.Name;
import com.example.epic.vpn.dns.DNS.PTRRecord;
import com.example.epic.vpn.dns.DNS.Record;
import com.example.epic.vpn.dns.DNS.Resolver;
import com.example.epic.vpn.dns.DNS.ReverseMap;
import com.example.epic.vpn.dns.DNS.TextParseException;
import com.example.epic.vpn.dns.DNS.Type;
